...
const translations = {
  fr: {
    ...
    "hero.downloadExeSub": "v1.1.0 · Setup.exe · 8.13 Mo · Gratuit à vie",
    "hero.githubBtn": "Code Source GitHub",
    "hero.githubSub": "AGPLv3 · Audit & Contribution",
    ...
    "features.title": "Les 8 Piliers Technologiques d'AiWidget",
  ...
  en: {
    ...
    "hero.downloadExeSub": "v1.1.0 · Setup.exe · 8.13 MB · Free for life",
    "hero.githubBtn": "GitHub Source Code",
    "hero.githubSub": "AGPLv3 · Audit & Contribute",
    ...
    "features.title": "The 8 Core Pillars of AiWidget",
  ...
  ar: {
    ...
    "hero.downloadExe": "تحميل LITE (مجاناً)",
    "hero.downloadExeSub": "الإصدار 1.1.0 · مثبت Setup.exe · 8.13 ميغابايت · مجاني مدى الحياة",
    "hero.githubBtn": "الكود على GitHub",
    "hero.githubSub": "AGPLv3 · مراجعة وتطوير",
    ...
    "features.title": "الركائز التقنية الثمانية لـ AiWidget",
