...
const translations = {
  fr: {
    ...
    "hero.downloadExeSub": "v1.1.0 · Setup.exe (9.03 Mo)",
    ...
    "features.desc": "Une suite logicielle complète intégrée dans un binaire natif Windows de seulement 9 Mo.",
  ...
  en: {
    ...
    "hero.downloadExeSub": "v1.1.0 · Setup.exe (9.03 MB)",
    ...
    "features.desc": "A full-scale native software suite engineered into an ultra-lightweight 9 MB Windows binary.",
  ...
  ar: {
    ...
    "hero.downloadExeSub": "الإصدار 1.1.0 · Setup.exe (9.03 ميغابايت)",
    ...
    "features.desc": "حزمة برمجية متكاملة مدمجة داخل تطبيق ويندوز فائق الخفة بحجم 9 ميغابايت فقط.",
