...
const translations = {
  fr: {
    ...
    "editions.f_lite6": "Vector DB & RAG sémantique local illimité",
    "editions.f_lite7": "Multi-profils sécurisés avec mot de passe local",
  ...
  en: {
    ...
    "editions.f_lite6": "Unlimited local Vector DB & semantic RAG",
    "editions.f_lite7": "Isolated multi-profiles with secure local passwords",
  ...
  ar: {
    ...
    "editions.f_lite6": "قاعدة بيانات متجهات RAG سيمانتك محلية غير محدودة",
    "editions.f_lite7": "ملفات مستخدمين متعددة ومحمية بكلمة سر محلية",
